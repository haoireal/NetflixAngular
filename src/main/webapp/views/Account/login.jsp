...
<body>
	...
	<div class="d-flex justify-content-center align-items-center"
		...
		<section class="login-box">
			<h2 class="text-white">Đăng nhập</h2>
			<form class="mt-4" action="/PhamGiaHaoASM/netflix/login" name="login-form"
				method="post">
				...
				<div class="mb-3 bg-white rounded px-2 d-flex"
					...
					<div class="">
						<input type="password" placeholder="Mật khẩu" value="${password}"
				...
				<button type="submit" class="btn btn-danger mt-3" value="Send"
